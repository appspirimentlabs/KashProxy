...
import com.appspiriment.kashproxy.databinding.KashproxyFragmentResponseMapListBinding
import com.appspiriment.kashproxy.databinding.KashproxyLayoutProxyMappingListItemBinding
...
internal class ResponseMapListFragment : Fragment() {
    ...
    private val adapter by lazy {
        BaseListAdapter<ResponseMappingModel, KashproxyLayoutProxyMappingListItemBinding>(
            itemLayoutId = R.layout.kashproxy_layout_proxy_mapping_list_item,
    ...
    ) = KashproxyFragmentResponseMapListBinding.inflate(inflater, container, false).apply {

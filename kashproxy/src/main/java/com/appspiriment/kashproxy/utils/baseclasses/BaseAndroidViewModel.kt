...
internal abstract class BaseAndroidViewModel(application: Application) : AndroidViewModel(application) {
    ...
    fun showToast(
        ...
        getApplication<Application>().showToast(MessageEvent.getToastEvent(message, toastDuration))
    }
